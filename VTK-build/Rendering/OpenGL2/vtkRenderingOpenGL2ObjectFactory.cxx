...
// Now create the functions to create overrides with.
  ...
  VTK_CREATE_CREATE_FUNCTION(vtkXInteractionDevice)
  VTK_CREATE_CREATE_FUNCTION(vtkXOpenGLRenderDevice)
...
vtkRenderingOpenGL2ObjectFactory::vtkRenderingOpenGL2ObjectFactory()
{
    ...
    this->RegisterOverride("vtkAbstractInteractionDevice",
                           "vtkXInteractionDevice",
                           "Override for vtkRenderingOpenGL2 module", 1,
                           vtkObjectFactoryCreatevtkXInteractionDevice);
    this->RegisterOverride("vtkAbstractRenderDevice",
                           "vtkXOpenGLRenderDevice",
                           "Override for vtkRenderingOpenGL2 module", 1,
                           vtkObjectFactoryCreatevtkXOpenGLRenderDevice);
